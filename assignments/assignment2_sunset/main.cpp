...
int main() {
	...
	std::string vertexShaderSource = AOD::loadShaderSourceFromFile("assets/vertexShader.vert");
	std::string fragmentShaderSource = AOD::loadShaderSourceFromFile("assets/fragmentShader.frag");
